...
/**
 * @file qbuem/middleware/token_auth.hpp
 ...
 *
 *   class HS256Verifier : public qbuem::middleware::ITokenVerifier {
 *   public:
...
struct BearerAuthOptions {
   ...
   *
   * Because qbuem Request is immutable inside middleware, claims are stored in
